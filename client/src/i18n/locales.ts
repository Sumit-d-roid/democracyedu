...
export const en = {
  ...
  "hero.tagline": "Know your rights. Strengthen democracy.",
  "hero.primaryCta": "Start Learning",
  "hero.secondaryCta": "Take a Quiz",
  ...
  "lessons.review": "Review Lesson",
  "lessons.continue": "Continue Lesson",
  ...
  "quiz.search": "Search",
  "quiz.no-results": "No quizzes match your search",
  "audience.filter.all": "All",
  "audience.filter.school": "School",
  "audience.filter.college": "College",
  ...
  "about.description": "SambhidanX helps learners explore Nepal's Constitution through structured lessons, quizzes, achievements, and bilingual support.",
  "about.mission": "Our mission is to make constitutional literacy engaging, inclusive, and accessible to every learner.",
  "about.short": "Explore Nepal's Constitution with bite-sized lessons, quizzes, and achievements—bilingual and learner-friendly.",
  "contact.title": "Contact Us",
  "contact.description": "Have feedback, questions, or collaboration ideas? Send us a message.",
  "contact.name": "Your Name",
  "contact.email": "Your Email",
  "contact.message": "Your Message",
  "contact.submit": "Send Message",
  "contact.thankyou": "Thank you! Your message has been sent.",
  "general.skip-to-content": "Skip to main content",
  "general.primary-navigation": "Primary navigation",
  "general.mobile-navigation": "Mobile navigation",
  "general.theme.toggle": "Toggle theme",
  "general.open-menu": "Open menu",
  "general.close-menu": "Close menu",
  "glossary.title": "Glossary of Constitutional Terms",
  "glossary.search": "Search terms...",
  "glossary.noresults": "No matching terms found.",
  "glossary.description": "Explore important constitutional and civic terms with concise bilingual explanations.",
  "footer.tagline": "Making constitutional literacy engaging and accessible.",
  "footer.navigation": "Footer navigation",
  "footer.rights": "All rights reserved.",
  "footer.trust-note": "Based on Nepal’s Constitution (2015). Designed for learners."
} as const;
...
export const ne = {
  ...
  "hero.tagline": "आफ्ना अधिकार जान्नुहोस्। लोकतन्त्र सुदृढ पार्नुहोस्।",
  "hero.primaryCta": "सिक्न सुरु गर्नुहोस्",
  "hero.secondaryCta": "क्विज दिनुहोस्",
  ...
  "lessons.review": "पाठ समीक्षा गर्नुहोस्",
  "lessons.continue": "पाठ जारी राख्नुहोस्",
  "lessons.inProgress": "प्रगतिमा",
  ...
  "quiz.search": "खोज्नुहोस्",
  "quiz.no-results": "कुनै क्विज मिलेन्",
  "audience.filter.all": "सबै",
  "audience.filter.school": "विद्यालय",
  "audience.filter.college": "कलेज",
  ...
  "about.title": "SambhidanX बारे",
  "about.description": "SambhidanX ले संरचित पाठ, क्विज, उपलब्धि र द्विभाषिक समर्थन मार्फत नेपालको संविधान बुझ्न मद्दत गर्दछ।",
  "about.mission": "हाम्रो उद्देश्य संविधान सम्बन्धी ज्ञानलाई रोचक, समावेशी र सबैका लागि पहुँचयोग्य बनाउनु हो।",
  "about.short": "नेपालको संविधानलाई साना पाठ, क्विज र उपलब्धिहरू मार्फत अन्वेषण गर्नुहोस्— द्विभाषिक र सिकाइमैत्री।",
  "contact.title": "हामीलाई सम्पर्क गर्नुहोस्",
  "contact.description": "प्रतिक्रिया, प्रश्न वा सहकार्यमूलक विचारहरू छन्? हामीलाई सन्देश पठाउनुहोस्।",
  "contact.name": "तपाईंको नाम",
  "contact.email": "तपाईंको इमेल",
  "contact.message": "तपाईंको सन्देश",
  "contact.submit": "सन्देश पठाउनुहोस्",
  "contact.thankyou": "धन्यवाद! तपाईंको सन्देश हामीसम्म पुगेको छ।",
  "general.skip-to-content": "मुख्य सामग्रीमा जानुहोस्",
  "general.primary-navigation": "मुख्य नेभिगेशन",
  "general.mobile-navigation": "मोबाइल नेभिगेशन",
  "general.theme.toggle": "थिम परिवर्तन गर्नुहोस्",
  "general.open-menu": "मेनु खोल्नुहोस्",
  "general.close-menu": "मेनु बन्द गर्नुहोस्",
  "glossary.title": "संवैधानिक शब्दहरूको शब्दकोश",
  "glossary.search": "शब्दहरू खोज्नुहोस्...",
  "glossary.noresults": "उचित मिल्ने शब्द फेला परेन।",
  "glossary.description": "संविधान र नागरिकतासंग सम्बन्धित महत्वपूर्ण शब्दहरूको द्विभाषिक व्याख्या अन्वेषण गर्नुहोस्।",
  "footer.tagline": "संवैधानिक ज्ञानलाई रोचक र पहुँचयोग्य बनाउँदै।",
  "footer.navigation": "फुटर नेभिगेशन",
  "footer.rights": "सबै अधिकार सुरक्षित।",
  "footer.trust-note": "नेपालको संविधान (२०१५) आधारित। सिक्नेहरूका लागि डिजाइन गरिएको।"
} as const;
