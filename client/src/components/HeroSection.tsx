...
export default function HeroSection() {
  ...
  <div className="absolute inset-0 bg-[radial-gradient(circle_at_28%_38%,rgba(255,255,255,0.10),transparent_65%)]" aria-hidden />
  <div className="absolute inset-x-0 bottom-0 h-28 bg-gradient-to-t from-background via-background/20 to-transparent" aria-hidden />
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-3xl relative">
          ...
          <h1 className="relative text-4xl md:text-5xl font-bold mb-6 leading-tight drop-shadow-sm fade-in-up text-white" style={{animationDelay:'.15s'}}>
          ...
          <p className="relative text-lg md:text-xl mb-7 leading-relaxed text-white/95 max-w-prose drop-shadow fade-in-up" style={{animationDelay:'.25s'}}>
            {t('hero.subtitle')}
          </p>
          <div className="relative flex flex-col sm:flex-row gap-4 mb-7 fade-in-up" style={{animationDelay:'.35s'}}>
            <Button
              size="lg"
          ...
          <p className="relative text-sm md:text-base text-white/85 max-w-2xl fade-in-up" style={{animationDelay:'.45s'}}>
            {t('about.short')}
          </p>
            ...
            >
              <span className="flex items-center gap-2">
                ...
                <span className="relative w-5 h-5 inline-flex items-center justify-center">
                  ...
                  <svg className="w-3.5 h-3.5 text-white/70 group-hover:text-white transition-colors" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8l4 4 4-4" /></svg>
